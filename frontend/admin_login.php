...
<head>
    <meta charset="utf-8">
    <title>Admin Login | CourseCraft</title>
        ...
        <div class="container py-3">
            <div class="row justify-content-center">
                <div class="col-lg-8 text-center">
                    <h1 class="display-4 text-white">Admin Login</h1>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container-xxl py-2 mt-4">
        <div class="row justify-content-center">
            <div class="col-lg-5 wow fadeInUp" data-wow-delay="0.3s">
                ...
                <?php endif; ?>
                <form class="shadow p-4" style="max-width: 550px;" method="post" class="bg-light rounded p-5">
                    ...
                    <button type="submit" class="btn btn-primary py-2 w-100 mb-3">Login</button>
